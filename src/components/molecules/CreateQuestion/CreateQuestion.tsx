...
//   console.log('data from createQuestion', data)
...
//             value={val}
//             onChange={handleQuestionDataChange}
//             helperText={`value should be less or equal to ${data?.currentTenant?.assessment_duration}`}
//             sx={{ marginTop: '15px' }}
//           />
//         </Grid>
...
const CreateQuestion = (props: QuestionProps) => {
  ...
  const isDurationExceeded = val > data?.currentTenant?.assessment_duration
  ...
  return (
    <>
      ...
      >
        ...
        <Grid item xs={12} sm={6}>
          <TextField
            className={isDurationExceeded ? styles.redInput : ''}
            fullWidth
            label='Duration'
            type='number'
            placeholder='Time to complete (in seconds)'
            ...
            InputProps={{
              ...
              // Apply redInput class if duration is exceeded
            }}
            name='duration'
            value={val}
            onChange={handleQuestionDataChange}
